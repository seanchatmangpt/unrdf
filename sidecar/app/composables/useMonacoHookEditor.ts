...
export interface HookEditorConfig {
 ...
 */
const getHookCompletionItems = (monaco: typeof Monaco): Monaco.languages.CompletionItem[] => {
 ...
 */
export function useMonacoHookEditor(config: HookEditorConfig = {}) {
  const editorInstance = ref<Monaco.editor.IStandaloneCodeEditor | null>(null)
  const isReady = ref(false)

  const initializeEditor = (monaco: typeof Monaco, editor: Monaco.editor.IStandaloneCodeEditor) => {
    ...
    if (!languages.find(lang => lang.id === hookLanguageConfig.id)) {
      ...
      monaco.languages.setMonarchTokensProvider(hookLanguageConfig.id, hookLanguageDefinition as any)
