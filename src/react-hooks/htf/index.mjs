...
export default {
  ...
  useLambdaScheduling: require('./useLambdaScheduling.mjs').default,
  usePiProfile: require('./usePiProfile.mjs').default,
  useGammaChecker: require('./useGammaChecker.mjs').default
};
