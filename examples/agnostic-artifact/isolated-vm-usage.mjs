/**
 * UNRDF latest - isolated-vm Sandbox Usage Example
 *
 * This example demonstrates the isolated-vm sandbox features in latest:
...
console.log('🔒 UNRDF latest - isolated-vm Sandbox Example\n');
...
console.log('  latest (isolated-vm): 95/100 ✅\n');
