...
const thesisShards = [
  // IMRaD family
  {
    ...
    content:
      'Current knowledge graphs are centralized, static, and lack semantic understanding. We propose a unified architecture addressing these limitations...',
    weight: 0.8,
  ...
  },
  {
    ...
    content:
      'The Hyper-Thesis Framework integrates 7 academic modes through three operations: Λ-ordering, Π-merging, Γ-globalization...',
    weight: 0.9,
    dependencies: ['intro'],
    metadata: { pages: 20 },
  },
  {
    ...
    content:
      'We implemented the HTF framework with React hooks providing scheduling, coherence analysis, and validation...',
    weight: 0.85,
  ...
  },
  {
    ...
    content:
      'Our results demonstrate that knowledge graphs can be unified across 7 writing modes while maintaining coherence...',
    weight: 0.8,
  ...
  // Argument family
  {
    ...
    content:
      'Current academic writing lacks a unifying framework that handles multiple modes coherently...',
    weight: 0.95,
  ...
  },
  {
    ...
    content:
      'Analysis of 50 recent PhD theses shows fragmentation across IMRaD, papers, argument, and narrative...',
    weight: 0.85,
  ...
  },
  {
    ...
    content:
      'We demonstrate that our framework achieves 91% coherence across 7 modes with Π-merging...',
    weight: 0.9,
  ...
  },
  {
    ...
    content:
      'Critics may argue that HTF is too complex for thesis writers accustomed to linear narratives...',
    weight: 0.6,
    dependencies: ['proof'],
  ...
  // Contribution family
  {
    ...
    content:
      'Academic writing modes (IMRaD, papers, argument, narrative) operate in isolation without coherence guarantees...',
    weight: 0.95,
    dependencies: ['problem'],
  ...
  },
  {
    ...
    content:
      'We design HTF as: Δ-shards → Λ-order → Π-merge → Γ-globalize, achieving μ-fixed point...',
    weight: 0.95,
  ...
  },
  {
    ...
    content:
      'We evaluate HTF on 10 thesis variants, achieving 91% coherence and <5% drift on average...',
    weight: 0.9,
  ...
  },
  {
    ...
    content:
      'HTF enables thesis writers to integrate multiple modes while maintaining coherence...',
    weight: 0.85,
  ...
  },
  {
    ...
    content:
      'We review canonical works on academic writing: Swales on IMRaD, Toulmin on argumentation...',
    weight: 0.85,
  ...
  // DSR family
  {
    ...
    content:
      'Thesis writers struggle with integrating multiple writing modes without losing coherence...',
    weight: 0.95,
    dependencies: [],
  ...
  },
  {
    ...
    content:
      'We build htf-core.mjs, useLambdaScheduling, usePiProfile, useGammaChecker with full JSDoc...',
    weight: 0.95,
  ...
  },
  {
    ...
    content:
      'We tell the story of discovering that thesis coherence requires multiple simultaneous perspectives...',
    weight: 0.75,
  ...
  },
  {
    ...
    content:
      'We trace the pattern: fragmentation → problem recognition → framework design → integration...',
    weight: 0.8,
  ...
  },
  {
    ...
    content:
      'The key insight: thesis coherence, like music or mathematics, has intrinsic beauty...',
    weight: 0.85,
...
function examplePiProfile() {
  ...
  console.log(
    `  Integration Strength: ${(profiler.analysis.coherence.integrationStrength * 100).toFixed(1)}%`
  );
  ...
  for (const [_family, profile] of Object.entries(profiler.analysis.profileByFamily)) {
    if (profile.count > 0) {
      console.log(
        `  ${profile.label}: ${profile.count}/${profile.expectedCount} (${profile.status})`
      );
    }
  }
...
function exampleCompleteFramework() {
  ...
  console.log(
    `  Families Represented: ${Object.values(stats.shards.byFamily).filter(c => c > 0).length}/7`
  );
