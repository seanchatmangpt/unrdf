 ...
 */
async function checkMotionCompliance(motionId, _graph) {
 ...
 */
async function validateWithShacl(_graph, _shapes) {
  ...
  return {
    ...
    results:
      Math.random() > 0.8 ? [{ message: 'Sample validation error', severity: 'Violation' }] : [],
  };
}
