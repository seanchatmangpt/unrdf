...
**Day 3:**
5. Create `@unrdf/knowledge-engine` separate repo
6. Move knowledge-engine code out of monorepo
7. Publish as standalone package

**Day 4:**
8. Decision point: Fix hooks OR remove
   - IF fix: Debug Zod, merge into core
   - IF remove: Document deprecation, remove package

**Day 5:**
9. Update permutation tests for new structure
10. Re-run all tests, document results
11. Update README/docs

### Week 2: Production Validation

**Day 1-3:**
12. Run OTEL validation on remaining packages
13. Benchmark performance
14. Update deployment docs

**Day 4-5:**
15. Create migration guide for users
16. Publish release notes
17. Release v5.0.0 stable (or v6.0.0 if breaking)
