/**
 * Main Commutativity Analysis API (without Zod validation for testing)
...
export function canReorder(capsuleA, capsuleB) {
  ...
  if (!capsuleA || !capsuleA.id || !capsuleA.add || !capsuleA.del) {
    throw new Error('Invalid capsuleA structure');
  }
  if (!capsuleB || !capsuleB.id || !capsuleB.add || !capsuleB.del) {
    throw new Error('Invalid capsuleB structure');
  }
