# Getting Started with @unrdf/knowledge-engine

**Time estimate:** 30-45 minutes
**Difficulty:** Beginner
**What you'll learn:** Basic usage of @unrdf/knowledge-engine

---

## Introduction

Welcome to @unrdf/knowledge-engine. This tutorial is designed to get you started quickly with hands-on examples.

## What You'll Learn

In this tutorial, you'll learn the basics of @unrdf/knowledge-engine including core concepts, how to install and set up the package, and how to run your first example successfully.
...
Understanding these key ideas will help you use @unrdf/knowledge-engine effectively:
...
Q: Is @unrdf/knowledge-engine production-ready? A: Yes, it's used in production systems today.
