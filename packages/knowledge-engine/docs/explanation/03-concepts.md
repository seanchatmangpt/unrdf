# Key Concepts: @unrdf/knowledge-engine
...
Fundamental ideas behind @unrdf/knowledge-engine:
...
Use @unrdf/knowledge-engine when you need its specific capabilities and performance characteristics.
