# Configuration: @unrdf/knowledge-engine
...
Configuration controls how @unrdf/knowledge-engine behaves. Different configurations suit different use cases and requirements.
