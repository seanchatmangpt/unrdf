/**
 * @file YAWL Workflow Time Machine - Case replay and time-travel
 * @module @unrdf/yawl/api/workflow-timemachine
 *
 * @description
 * Handles case replay and time-travel functionality using KGC-4D reconstructState.
