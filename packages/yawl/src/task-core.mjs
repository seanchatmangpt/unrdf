...
export const TaskDefinitionSchema = z.object({
  ...
  semanticCondition: z.object({
    query: z.string(),
    ontologyFiles: z.array(z.string()).optional(),
  }).optional(),
  decomposesTo: z.string().optional(),
  multipleInstance: z
    .object({
      lowerBound: z.union([z.number(), z.string()]).default(1),
      upperBound: z.union([z.number(), z.string()]).default(1),
      threshold: z.union([z.number(), z.string()]).optional(),
      creationMode: z.enum(['static', 'dynamic']).default('static'),
      miStrategy: z.enum(['WP12', 'WP13', 'WP14', 'WP15']).optional(),
    })
    .optional(),
});
...
export class TaskDefinition {
  ...
  constructor(spec) {
    ...
    /** @type {Object|undefined} Multiple instance configuration */
    this.multipleInstance = validated.multipleInstance;
  }
