...
### [@unrdf/browser](/api/browser)
Browser-optimized RDF bundle with streaming support.

- **BrowserStore** - IndexedDB-backed RDF store
- **StreamingParser** - Incremental N3/Turtle parsing

[View @unrdf/browser API →](/api/browser)
