...
function generateDataset(size) {
  ...
  for (let i = 0; i < size; i++) {
    ...
    quads.push(triple(subject, agePred, literal(20 + (i % 50), namedNode('http://www.w3.org/2001/XMLSchema#integer'))))
  }
  return quads
}
...
class OxigraphBenchmark {
  ...
  benchmarkCONSTRUCT() {
    ...
    const query = 'CONSTRUCT { ?s <http://schema.org/name> ?name } WHERE { ?s <http://schema.org/name> ?name } LIMIT 50'
