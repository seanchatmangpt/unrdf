# How To: Solve SlowQueries

**Time estimate:** 30-45 minutes
**Difficulty:** Intermediate
**Context:** When you encounter SlowQueries

---

## Problem Statement

SlowQueries is a common challenge when using @unrdf/dark-matter. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing SlowQueries if:
- Errors mentioning SlowQueries appear in logs
...
SlowQueries typically occurs when:
...
```javascript
const result = await instance.optimizeQuery();
console.log('Success! SlowQueries resolved.');
```
...
Here's a complete example addressing SlowQueries in production:
...
To avoid SlowQueries in the future:
