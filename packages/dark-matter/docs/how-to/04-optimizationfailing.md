# How To: Solve OptimizationFailing

**Time estimate:** 1 hour
**Difficulty:** Advanced
**Context:** When you encounter OptimizationFailing

---

## Problem Statement

OptimizationFailing is a common challenge when using @unrdf/dark-matter. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing OptimizationFailing if:
- Errors mentioning OptimizationFailing appear in logs
...
OptimizationFailing typically occurs when:
...
```javascript
const result = await instance.optimizeQuery();
console.log('Success! OptimizationFailing resolved.');
```
...
Here's a complete example addressing OptimizationFailing in production:
...
To avoid OptimizationFailing in the future:
