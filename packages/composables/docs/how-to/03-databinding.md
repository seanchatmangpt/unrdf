# How To: Solve DataBinding

**Time estimate:** 1 hour
**Difficulty:** Advanced
**Context:** When you encounter DataBinding

---

## Problem Statement

DataBinding is a common challenge when using @unrdf/composables. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing DataBinding if:
- Errors mentioning DataBinding appear in logs
...
DataBinding typically occurs when:
...
```javascript
const result = await instance.useRdfStore();
console.log('Success! DataBinding resolved.');
```
...
Here's a complete example addressing DataBinding in production:
...
To avoid DataBinding in the future:
