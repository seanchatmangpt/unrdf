...
describe('MLVersionStore', () => {
  ...
  describe('Time-Travel Queries', () => {
    it('should retrieve version at specific timestamp', async () => {
      ...
      expect(version.metrics.accuracy).toBeCloseTo(0.8);
  ...
  describe('Version Comparison', () => {
    it('should compare two model versions', async () => {
      ...
      // Check metrics delta
      expect(comparison.metricsDelta.accuracy.from).toBeCloseTo(0.75);
      expect(comparison.metricsDelta.accuracy.to).toBeCloseTo(0.90);
      expect(comparison.metricsDelta.accuracy.change).toBeCloseTo(0.15);
      expect(comparison.metricsDelta.accuracy.percentChange).toBeCloseTo(20);

      expect(comparison.metricsDelta.loss.from).toBeCloseTo(0.5);
      expect(comparison.metricsDelta.loss.to).toBeCloseTo(0.3);
      expect(comparison.metricsDelta.loss.change).toBeCloseTo(-0.2);
