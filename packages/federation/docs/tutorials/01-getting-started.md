# Getting Started with @unrdf/federation

**Time estimate:** 30-45 minutes
**Difficulty:** Beginner
**What you'll learn:** Basic usage of @unrdf/federation

---

## Introduction

Welcome to @unrdf/federation. This tutorial is designed to get you started quickly with hands-on examples.

## What You'll Learn

In this tutorial, you'll learn the basics of @unrdf/federation including core concepts, how to install and set up the package, and how to run your first example successfully.
...
Understanding these key ideas will help you use @unrdf/federation effectively:
...
Q: Is @unrdf/federation production-ready? A: Yes, it's used in production systems today.
