...
export async function createUniversalStore() {
  ...
  // Add some triples
  store.add(new Quad('http://example.org/Alice', 'http://schema.org/name', 'Alice'));

  store.add(new Quad('http://example.org/Alice', 'http://schema.org/age', '30'));

  store.add(new Quad('http://example.org/Bob', 'http://schema.org/name', 'Bob'));

  store.add(
    new Quad('http://example.org/Bob', 'http://schema.org/knows', 'http://example.org/Alice')
  );
