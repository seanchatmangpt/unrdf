...
**Difficulty:** Beginner
**What you'll learn:** Basic usage of @unrdf/cli

---

## Introduction

Welcome to @unrdf/cli. This tutorial is designed to get you started quickly with hands-on examples.

## What You'll Learn

In this tutorial, you'll learn the basics of @unrdf/cli including core concepts, how to install and set up the package, and how to run your first example successfully.
...
Understanding these key ideas will help you use @unrdf/cli effectively:
...
Q: Is @unrdf/cli production-ready? A: Yes, it's used in production systems today.
