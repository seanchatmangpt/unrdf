# Getting Started with @unrdf/browser

**Time estimate:** 30-45 minutes
**Difficulty:** Beginner
**What you'll learn:** Basic usage of @unrdf/browser

---

## Introduction

Welcome to @unrdf/browser. This tutorial is designed to get you started quickly with hands-on examples.

## What You'll Learn

In this tutorial, you'll learn the basics of @unrdf/browser including core concepts, how to install and set up the package, and how to run your first example successfully.
...
Understanding these key ideas will help you use @unrdf/browser effectively:
...
Q: Is @unrdf/browser production-ready? A: Yes, it's used in production systems today.
