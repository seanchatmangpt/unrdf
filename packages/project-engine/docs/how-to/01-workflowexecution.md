# How To: Solve WorkflowExecution

**Time estimate:** 30-45 minutes
**Difficulty:** Intermediate
**Context:** When you encounter WorkflowExecution

---

## Problem Statement

WorkflowExecution is a common challenge when using @unrdf/project-engine. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing WorkflowExecution if:
- Errors mentioning WorkflowExecution appear in logs
...
WorkflowExecution typically occurs when:
...
```javascript
const result = await instance.createProject();
console.log('Success! WorkflowExecution resolved.');
```
...
Here's a complete example addressing WorkflowExecution in production:
...
To avoid WorkflowExecution in the future:
