# How To: Solve PerformanceScaling

**Time estimate:** 1 hour
**Difficulty:** Advanced
**Context:** When you encounter PerformanceScaling

---

## Problem Statement

PerformanceScaling is a common challenge when using @unrdf/project-engine. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing PerformanceScaling if:
- Errors mentioning PerformanceScaling appear in logs
...
PerformanceScaling typically occurs when:
...
```javascript
const result = await instance.createProject();
console.log('Success! PerformanceScaling resolved.');
```
...
Here's a complete example addressing PerformanceScaling in production:
...
To avoid PerformanceScaling in the future:
