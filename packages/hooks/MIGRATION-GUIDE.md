# Migration Guide - UNRDF Hooks [VERSION]
...
If you're upgrading from [VERSION]-[VERSION]:
...
- Old receipts from [VERSION]-[VERSION] should be marked as legacy
...
```bash
# Go back to [VERSION] (still recommended to upgrade)
npm install @unrdf/hooks@[VERSION]

# Go back to [VERSION] (re-introduces security issue)
npm install @unrdf/hooks@[VERSION]  # ⚠️ SECURITY ISSUE
```
...
- [ ] Upgraded to @unrdf/hooks@[VERSION]
- [ ] Verified @noble/hashes@[VERSION]+ is installed
- [ ] Ran full test suite successfully
- [ ] Old receipts from [VERSION]-[VERSION] archived or deleted
...
| ------- | ---------- | ---------- | ----------------------------------------- |
| [VERSION]  | 2026-04-04 | CURRENT    | Security fix (BLAKE3) + 5 major features  |
| [VERSION]  | 2026-04-03 | Previous   | Vision 2030 Phase 1 work                  |
| [VERSION]  | 2026-03-15 | Deprecated | Had weak hashing vulnerability            |
| [VERSION]  | 2026-03-01 | Deprecated | Earlier maturity work                     |
| [VERSION]  | 2026-01-15 | Deprecated | Initial v26.4 release (had vulnerability) |
