# Migration Guide - UNRDF Hooks v26.5.4

**Current Version:** v26.5.4  
...
If you're upgrading from v26.5.4-v26.5.4:
...
- Old receipts from v26.5.4-v26.5.4 should be marked as legacy
...
```bash
# Go back to v26.5.4 (still recommended to upgrade)
npm install @unrdf/hooks@26.5.4

# Go back to v26.5.4 (re-introduces security issue)
npm install @unrdf/hooks@26.5.4  # ⚠️ SECURITY ISSUE
```
...
- [ ] Upgraded to @unrdf/hooks@26.5.4
- [ ] Verified @noble/hashes@2.0.1+ is installed
- [ ] Ran full test suite successfully
- [ ] Old receipts from v26.5.4-v26.5.4 archived or deleted
...
| ------- | ---------- | ---------- | ----------------------------------------- |
| 26.5.4  | 2026-04-04 | CURRENT    | Security fix (BLAKE3) + 5 major features  |
| 26.5.4  | 2026-04-03 | Previous   | Vision 2030 Phase 1 work                  |
| 26.5.4  | 2026-03-15 | Deprecated | Had weak hashing vulnerability            |
| 26.5.4  | 2026-03-01 | Deprecated | Earlier maturity work                     |
| 26.5.4  | 2026-01-15 | Deprecated | Initial v26.4 release (had vulnerability) |
