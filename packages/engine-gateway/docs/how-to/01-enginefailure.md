# How To: Solve EngineFailure

**Time estimate:** 30-45 minutes
**Difficulty:** Intermediate
**Context:** When you encounter EngineFailure

---

## Problem Statement

EngineFailure is a common challenge when using @unrdf/engine-gateway. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing EngineFailure if:
- Errors mentioning EngineFailure appear in logs
...
EngineFailure typically occurs when:
...
```javascript
const result = await instance.createGateway();
console.log('Success! EngineFailure resolved.');
```
...
Here's a complete example addressing EngineFailure in production:
...
To avoid EngineFailure in the future:
