# How To: Solve ResultMerging

**Time estimate:** 1 hour
**Difficulty:** Advanced
**Context:** When you encounter ResultMerging

---

## Problem Statement

ResultMerging is a common challenge when using @unrdf/engine-gateway. This guide shows you exactly how to diagnose and fix it.

---

## Symptoms

You might be experiencing ResultMerging if:
- Errors mentioning ResultMerging appear in logs
...
ResultMerging typically occurs when:
...
```javascript
const result = await instance.createGateway();
console.log('Success! ResultMerging resolved.');
```
...
Here's a complete example addressing ResultMerging in production:
...
To avoid ResultMerging in the future:
