...
**Type**: `string`
**Default**: `service.name=unrdf-daemon,service.version=26.4.3`
**Description**: Comma-separated list of additional resource attributes

**Example**:

```bash
export OTEL_RESOURCE_ATTRIBUTES=service.name=unrdf-daemon,service.version=26.4.3,deployment.environment=production
```
