...
/**
 * @file codegen/scripts/sync-packages.mjs
 * @module codegen/scripts/sync-packages
 * @description Discover all UNRDF packages from package.json files and sync to RDF ontology
 *
 * Usage:
 *   node codegen/scripts/sync-packages.mjs [--output schemas/unrdf-packages.ttl] [--update]
 */
...
# ============================================================================
# UNRDF Package Ontology - Auto-generated by codegen/scripts/sync-packages.mjs
# ============================================================================
...
async function main() {
  ...
  console.log(`   2. Define generation rules in codegen.toml`);
  console.log(`   3. Run unrdf sync to generate code and documentation`);
}
