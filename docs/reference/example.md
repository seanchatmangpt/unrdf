# Knowledge Graph Circuits - API Reference

> **Reference Documentation**: Technical specifications and API details
...
This API returns structured data according to the KGC specification.
...
```json
{
  ...
  "receipt_count": 2,
  "timestamp": "2025-12-27T00:02:06.578Z"
}
```
