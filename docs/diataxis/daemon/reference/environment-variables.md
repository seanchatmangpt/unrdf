...
| `OTEL_SERVICE_VERSION`     | `26.4.23`                                           | Service version attached to all spans.          |
| `OTEL_RESOURCE_ATTRIBUTES` | `service.name=unrdf-daemon,service.version=26.4.23` | Comma-separated additional resource attributes. |
