...
UNRDF latest is a **major version release** that represents a strategic refocusing on the core knowledge engine. This release removes experimental features (CLI, sidecar) to deliver a production-ready, composable RDF knowledge graph library.
...
@unrdf/sidecar@latest         # Sidecar (separate package, future)
```
