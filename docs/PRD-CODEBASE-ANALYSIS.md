...
- **Clear architectural focus** - latest removed experimental CLI/sidecar to focus on core
...
**Version History:**
- latest (October 2, 2025) - Major refocus: removed CLI/sidecar, 100% core test coverage
- latest - Previous stable release (had experimental CLI/sidecar)
