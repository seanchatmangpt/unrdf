...
- [How to [Related Task]](./related-guide.md)
- [How to [Another Related Task]](./another-guide.md)

## API Reference

- [Module.function()](../reference/api/module.md#function) - [Brief description]
- [Module.otherFunction()](../reference/api/module.md#otherFunction) - [Brief description]

## Further Reading

- [Explanation: [Concept]](../explanation/concept.md) - Understand why this works
