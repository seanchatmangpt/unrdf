# UNRDF latest API Reference Summary

**Last Updated:** March 15, 2026

---

## New Exports in latest
...
## createDarkMatterCore (Enhanced in latest)

Create a knowledge engine with new latest features.

**New options in latest:**

```javascript
const system = await createDarkMatterCore({
  // New: isolated-vm sandbox
  sandbox: {
    engine: 'isolated-vm',        // Default in latest
...
All v3.0.x APIs remain unchanged in latest:
