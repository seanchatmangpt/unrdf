...
- `@unrdf/core`: workspace:latest-beta.1
- `@unrdf/decision-fabric`: workspace:latest-beta.1
- `@unrdf/federation`: workspace:latest-beta.1
- `@unrdf/hooks`: workspace:latest-beta.1
- `@unrdf/streaming`: workspace:latest-beta.1
- `citty`: ^latest
- `table`: ^latest
- `yaml`: ^latest
