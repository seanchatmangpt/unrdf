# UNRDF latest Architecture Analysis
**Date**: 2025-10-02
...
|---------|---------|--------|------|--------|
| `n3` | ^latest | ✅ Active | Low | None |
| `@comunica/query-sparql` | ^latest | ✅ Active | Low | Monitor updates |
| `rdf-validate-shacl` | ^latest | ⚠️ Older | Medium | Consider upgrade |
| `eyereasoner` | ^latest | ✅ Stable | Low | None |
| `zod` | ^latest | ✅ Active | Low | None |
| `vm2` | ^latest | ⚠️ Deprecated | **HIGH** | **Replace with isolated-vm** |
| `@opentelemetry/*` | ^latest | ⚠️ Mixed | Medium | Update to latest stable |
