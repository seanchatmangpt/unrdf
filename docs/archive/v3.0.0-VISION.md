# UNRDF v3.0.0 - Major Release Vision
...
UNRDF v3.0.0 is a **major version release** that represents a strategic refocusing on the core knowledge engine. This release removes experimental features (CLI, knowledge-engine) to deliver a production-ready, composable RDF knowledge graph library.
