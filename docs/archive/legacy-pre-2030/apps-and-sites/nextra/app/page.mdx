...
<div style={{ padding: '12px 16px', background: '#f0f9ff', border: '1px solid #0ea5e9', borderRadius: '8px', marginTop: '16px', marginBottom: '16px' }}>
  <strong>🕐 Last Built:</strong> {new Date().toUTCString()}
</div>
