...
**Success Rate:** latest% (based on testing)
...
### Performance Metrics
- **Test duration:** Baseline latests, threshold 5s, rollback >10s
...
# 2025-12-27T12:00:latestZ [INFO] V6 Rollback Script
# 2025-12-27T12:04:latestZ [SUCCESS] ✓ Rollback completed successfully
# Duration: 4m 32s
...
# Test suite: latests (baseline: latests, +228% regression)
...
# After rollback
timeout 60s pnpm benchmark:compare
# Test suite: latests (baseline: latests, +4% within tolerance)
