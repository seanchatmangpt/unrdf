# latest Integration Quick-Start Guide

**Target Release**: latest (Q1 2026)
...
pnpm quality:json > latest-quality.json

# Verify all integrations documented
grep -r "latest" docs/diataxis/ | wc -l  # Should be ≥15
```
...
5. **Prepare Demos**: One demo per integration for latest launch
