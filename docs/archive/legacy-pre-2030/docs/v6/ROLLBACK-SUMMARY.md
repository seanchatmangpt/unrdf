# Rollback # V6 Rollback & Contingency Plan - Delivery Summary Contingency Plan - Delivery Summary
...
#### `/home/user/unrdf/scripts/rollback.mjs` (446 lines)
...
#### `/home/user/unrdf/scripts/snapshot.mjs` (227 lines)
...
```bash
# Command
node scripts/snapshot.mjs test-snapshot-$(date +%Y%m%d-%H%M%S)
...
```bash
# Command
node scripts/rollback.mjs --dry-run --snapshot v5-stable-baseline

# Result
[INFO] Rollback Script
[INFO] Dry Run: true
...
- Command: `node scripts/rollback.mjs --dry-run`
...
node scripts/snapshot.mjs pre-production-20251227
# ✓ Snapshot created successfully
...
# 2025-12-27T12:00:00.000Z [INFO] Rollback Script
