...
### Option 1: SPARQL Federation Only (W3C SPARQL latest Federation)
...
1. Standard SPARQL latest Federation for compatibility
...
│
├── adapters/
│   ├── sparql-adapter.mjs          # SPARQL latest Federation
...
- [SPARQL latest Federation](https://www.w3.org/TR/sparql11-federated-query/)
- [CRDTs: Consistency without concurrency control](https://arxiv.org/abs/latest)
