...
UNRDF latest is a **focused core release** delivering production-ready RDF knowledge graph functionality. This release excludes CLI and sidecar components, which will be delivered in separate future releases.
