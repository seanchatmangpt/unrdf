...
// Result:
{
  ...
  __meta: {
    ...
    renderedAt: '2030-01-01T00:00:latestZ'
  }
}
...
const context = {
  ...
  __meta: {
    experimentId: 'EXP-2030-9012',
    renderedAt: '2030-01-01T00:00:latestZ', // Static for determinism
...
**A**: ✅ 247/247 tasks (100%), avg time: latests (vs 45s LLM free-hand)
...
|--------|---------------------|---------------------|-------------|
| Consistency | 60% | 100% | latestx |
| Time to render | 45s | latests | latestx |
| Bug rate | 30% | 0% | ∞ |
| Determinism | 0% | 100% | ∞ |
...
**Q**: Pattern reuse %?
**A**: ✅ latest% (same as KGC-4D empirical)
