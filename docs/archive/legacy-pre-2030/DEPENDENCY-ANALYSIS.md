...
|---------|-------------|----------|-------|
| @unrdf/hooks | latest | latest | Moderate distance from main sequence |
| @unrdf/kgc-4d | latest | latest | Moderate distance from main sequence |
...
**Issue:** This package has 6 dependents but high instability (latest).
...
|------|---------|---------|
| 2025-12-26 | latest | Initial analysis |

---

*Generated by UNRDF Dependency Analyzer vlatest*
