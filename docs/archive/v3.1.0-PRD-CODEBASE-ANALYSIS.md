...
- **Clear architectural focus** - v3.0.0 removed experimental CLI/knowledge-engine to focus on core
...
**Version History:**
- v3.0.0 (October 2, 2025) - Major refocus: removed CLI/knowledge-engine, 100% core test coverage
- v2.4.0 - Previous stable release (had experimental CLI/knowledge-engine)
