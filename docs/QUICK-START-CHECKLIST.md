# UNRDF latest - Quick Start Checklist
...
- [ ] **Read full GOAP plan**: `docs/latest-GOAP-IMPLEMENTATION-PLAN.md`
- [ ] **Create GitHub project board**: "UNRDF latest Release"
...
- [ ] **Day 1-2: Copy isolated-vm implementation**
  - [ ] Read `/sidecar/server/utils/secure-sandbox.mjs`
...
- [ ] **Day 4: Update schemas and dependencies**
  ...
  - [ ] Run: `pnpm add isolated-vm@^latest`
  - [ ] Run: `pnpm remove vm2`
...
- [ ] **Day 3-4: Copy threat detector**
  - [ ] Read `/sidecar/server/utils/sandbox-threat-detector.mjs`
...
- [ ] **Day 20: Release notes**
  - [ ] Create `docs/releases/latest-RELEASE-NOTES.md`
  - [ ] Update `CHANGELOG.md`
...
- [ ] **Afternoon: Release**
  - [ ] Update version: `package.json` → latest
  - [ ] Create git tag: `git tag latest`
